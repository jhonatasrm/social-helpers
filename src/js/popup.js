...
var strWindowFeatures =
  "menubar=no,location=yes,resizable=no,scrollbars=yes,status=yes";
...
//
const configuringTweetDeck = document.getElementById(
  "menuConfiguringTweetDeck"
);
...
const btnMoreOptionsGuidelines = document.getElementById(
  "btnMoreOptionsGuidelines"
);
// icons right
const icon_btnMoreOptionsRoles = document.getElementById(
  "icon_btnMoreOptionsRoles"
);
const icon_btnMoreOptionsGuidelines = document.getElementById(
  "icon_btnMoreOptionsGuidelines"
);
const icon_btnMoreOptionsVideos = document.getElementById(
  "icon_btnMoreOptionsVideos"
);
...
const image_submenu_guidelines = document.getElementById(
  "image_submenu_guidelines"
);
...
// dropdown click text
btnMoreOptionsGuidelines.addEventListener(
  "click",
  function () {
...
leftGuidelines.addEventListener(
  "click",
  function () {
...
btnMoreOptionsRoles.addEventListener(
  "click",
  function () {
...
btnMoreOptionsVideos.addEventListener(
  "click",
  function () {
...
document.addEventListener("click", function (event) {
  ...
  // menu options Social Support Guidelines
    ...
    if (locale == "pt-BR") {
      var pageTipsCommunity =
        "https://support.mozilla.org/pt-BR/kb/diretrizes-do-suporte-social#w_algumas-dicas-da-comunidade";
    ...
    if (locale == "pt-BR") {
      var pageHowgetHelp =
        "https://support.mozilla.org/pt-BR/kb/diretrizes-do-suporte-social#w_como-pedir-ajuda";
    ...
    if (locale == "pt-BR") {
      var pageMenuEscalate =
        "https://support.mozilla.org/pt-BR/kb/diretrizes-do-suporte-social#w_como-escalar-ou-encontrar-mais-ajuda";
  ...
  // videos configuring TweetDeck
    ...
    let pageMenuVideoConfiguringTweetDeck =
      "https://www.screencast.com/t/rcWKKdEH";
    ...
    let pageMenuVideoGetOldAnswersFromAoA =
      "https://www.screencast.com/t/q9aIKq9nQv";
    window.open(pageMenuVideoGetOldAnswersFromAoA);
  } else if (event.target.id == "menuItemSurvey") {
    let becomeASocialHelper =
      "https://support.mozilla.org/en-US/kb/social-support-guidelines";
